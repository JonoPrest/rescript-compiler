...
val declare_variable : kind:Lam_compat.let_kind -> Ident.t -> t
...
val assign : J.ident -> J.expression -> t
...
val while_ : ?label:J.label -> J.expression -> J.block -> t
...
val for_of : ?label:J.label -> J.expression -> J.ident -> J.block -> t

val for_await_of :
  ?label:J.label -> J.expression -> J.ident -> J.block -> t

val try_ : ?with_:J.ident * J.block -> J.block -> t

val exp : J.expression -> t

val return_stmt : J.expression -> t
